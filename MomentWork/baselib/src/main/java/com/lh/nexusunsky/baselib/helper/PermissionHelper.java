package com.lh.nexusunsky.baselib.helper;
...
public class PermissionHelper {
    ...
    @IntDef({CODE_RECORD_AUDIO, CODE_GET_ACCOUNTS, CODE_READ_PHONE_STATE, CODE_CALL_PHONE, CODE_CAMERA,
    ...
    private void requestMultiResult(String[] permissions, int[] grantResults, OnPermissionGrantListener
    ...
    public void autoRequestPermissions(OnPermissionGrantListener listener) {
        ...
        if (permissionsList.size() > 0) {
            requestPermissionsInternal(permissionsList.toArray(new String[permissionsList.size()]),
            ...
            shoMessageDialog(getContext(), "需要权限", "确定", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    requestPermissionsInternal(shouldRationalePermissionsList.toArray(new
    ...
    private void shouldShowRationale(final Context activity, final int requestCode, final String requestPermission) {
        ...
        shoMessageDialog(activity, "Rationale: " + permissionsHint[requestCode], "确定", new DialogInterface
                .OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                requestPermissionsInternal(new String[]{requestPermission}, requestCode);
    ...
    private static void shoMessageDialog(final Context context, String message, String buttonText, final
    ...
    private void requestPermissionsInternal(final @NonNull String[] permissions, final @IntRange(from = 0) int
            requestCode) {
        if (getActivity() != null) {
