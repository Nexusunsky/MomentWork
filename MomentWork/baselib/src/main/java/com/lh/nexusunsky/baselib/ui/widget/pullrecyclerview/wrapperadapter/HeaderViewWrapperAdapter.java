package com.lh.nexusunsky.baselib.ui.widget.pullrecyclerview.wrapperadapter;
...
public class HeaderViewWrapperAdapter extends RecyclerView.Adapter implements WrapperRecyclerAdapter {
    ...
    private RecyclerView.AdapterDataObserver mDataObserver = new RecyclerView.AdapterDataObserver() {
        ...
        public void onItemRangeMoved(int fromPosition, int toPosition, int itemCount) {
            ...
            notifyItemRangeChanged(fromPosition + headerViewsCountCount, toPosition + headerViewsCountCount +
                    itemCount);
        }
    };


    public HeaderViewWrapperAdapter(RecyclerView recyclerView, @NonNull RecyclerView.Adapter mWrappedAdapter,
    ...
    private void checkAndSetRecyclerViewLayoutParams(View child) {
        ...
        if (p == null) {
            p = new LayoutParams(new MarginLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams
                    .WRAP_CONTENT)));
        } else {
    ...
    private boolean onCreateHeaderViewHolder(int viewType) {
        return mHeaderViewInfos.size() > 0 && viewType <= FixedViewInfo.ITEM_VIEW_TYPE_HEADER_START
                && viewType > FixedViewInfo.ITEM_VIEW_TYPE_FOOTER_START;
    }
